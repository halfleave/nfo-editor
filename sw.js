 ...
 * 注意：2026-08-12 升 v2，2026-08-26 升 v5→v6→v7→v8→v9→v10→v11→v12→v13→v14→v15→v16→v17→v18（去掉磁力番号 tab，AV 磁力直接按番号搜、无 tab），清掉旧版缓存，避免 iOS 主屏 PWA 一直跑旧 HTML。
 */
const CACHE = 'nfo-ios-v18';
