 ...
 * v104（2026-08-28）：新增 manifest.json（display:standalone，配合 apple-mobile-web-app-capable）并加入预缓存，修复 iOS 16.4+ 主屏 PWA 底部出现 Safari 导航栏的问题。
 */
const CACHE = 'nfo-ios-v104';
