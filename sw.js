 ...
 * 注意：2026-08-12 升 v2，2026-08-26 升 v5→v6→v7→v8→v9→v10→v11→v12→v13→v14→v15→v16→v17→v18→v19（预告片弹窗：把「在浏览器打开」按钮缩小并放到标题右侧），清掉旧版缓存，避免 iOS 主屏 PWA 一直跑旧 HTML。
 */
const CACHE = 'nfo-ios-v19';
